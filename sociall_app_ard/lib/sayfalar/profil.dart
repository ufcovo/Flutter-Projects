...
import 'package:sociall_app_ard/sayfalar/profiliduzenle.dart';
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(profilData.hakkinda!, style: TextStyle(fontSize: 15.0)),
          SizedBox(
            height: 25.0,
          ),
          widget.profilSahibiId == _aktifKullaniciId
              ? _prifiliDuzenleButon()
              : _takipButonu(),
        ],
      ),
    );

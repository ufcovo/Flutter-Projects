...
import 'package:sociall_app_ard/sayfalar/yorumlar.dart';
...
class _GonderiKartiState extends State<GonderiKarti> {
  ...
  Widget _gonderiBasligi() {
    return ListTile(
        ...
        child: GestureDetector(
          ...
          child: CircleAvatar(
              ...
              backgroundImage: widget.yayinlayan!.fotoUrl!.isNotEmpty
                  ...
                  : AssetImage("assets/images/empty.jpg") as ImageProvider),
        ),
      ),
      title: GestureDetector(
        ...
        child: Text(
          widget.yayinlayan!.kullaniciAdi.toString(),
          style: TextStyle(
            fontSize: 14.0,
  ...
  Widget _gonderiResmi() {
    return GestureDetector(
      ...
      child: Image.network(
        widget.gonderi!.gonderiResmiUrl.toString(),
